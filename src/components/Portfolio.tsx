...
import { Briefcase, ArrowUpRight, Sparkles, Filter, Layers } from 'lucide-react';
...
export const Portfolio: React.FC<PortfolioProps> = ({ lang }) => {
  ...
  const categories: { key: ProjectCategory; label: string }[] = [
    ...
    { key: 'web-app', label: t.filterWebApp },
    { key: 'ecommerce', label: t.filterEcommerce },
    { key: 'ui-ux', label: t.filterUiUx },
              ...
              return (
                ...
                >
                  <div
                    ...
                    className={`h-full rounded-[32px] bg-white border border-stone-200/90 shadow-2xs hover:shadow-lg hover:border-indigo-200/90 transition-all duration-300 overflow-hidden cursor-pointer flex flex-col ${
                  ...
                  >
                    ...
                    <div
                      className={`p-6 sm:p-8 flex flex-col justify-between ${
                        isWide ? 'lg:w-5/12 border-t lg:border-t-0 lg:border-s border-stone-100' : 'border-t border-stone-100'
                      }`}
                    >
                      <div>
                        ...
                        <div className="flex items-center justify-between gap-2 mb-3">
                          ...
                          {project.featured && (
                            <span className="px-2.5 py-0.5 rounded-full bg-amber-50 text-amber-800 border border-amber-200/70 text-[11px] font-bold flex items-center gap-1">
                        ...
                        {/* Title */}
                        <h3 className="text-xl sm:text-2xl font-black text-stone-900 mb-2 tracking-tight group-hover:text-indigo-600 transition-colors">
                          {project.title[lang]}
                        </h3>

                        {/* Subtitle */}
                        <p className="text-xs sm:text-sm font-semibold text-stone-500 mb-3">
                      ...
                      <div>
                        ...
                        <div className="flex flex-wrap gap-1.5 mb-6">
                          ...
                          {project.technologies.length > 4 && (
                            <span className="px-2 py-1 rounded-lg bg-stone-50 text-stone-500 text-[11px] font-medium">
                              +{project.technologies.length - 4}
                            </span>
                          )}
                        </div>
                        ...
                        <div className="flex items-center justify-between pt-4 border-t border-stone-100">
                          <span className="inline-flex items-center gap-1.5 text-xs sm:text-sm font-bold text-indigo-600 group-hover:text-indigo-800 group-hover:underline">
